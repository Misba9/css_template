...
$(function() {
  ...
  // Slider
  $('#coin-slider').coinslider({width:943,height:311,opacity:1});

  // Radius Box
  $('p.infopost, .content p.pages span, .content p.pages a, .content .mainbar img.fl, .fbg_resize').css({"border-radius":"6px", "-moz-border-radius":"6px", "-webkit-border-radius":"6px"});
