...
$(function() {
  ...
  // Slider
  $('#coin-slider').coinslider({width:912,height:304,opacity:1});

  // Radius Box
  $('.post_content a.rm, .content p.pages span, .content p.pages a').css({"border-radius":"10px", "-moz-border-radius":"10px", "-webkit-border-radius":"10px"});
